...
void partF(char *test[1000]){
	...
	endGrind(test);
	printf("PartF is an error test case, there will be a lot of errors printed out; this is not our program crashing or working improperly, it is showing how our malloc wont allow over 5000 bytes to be allocated and shows how it doesn't break\n");
}
