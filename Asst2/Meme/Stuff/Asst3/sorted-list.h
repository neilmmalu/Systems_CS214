...
int intCompare( void * firstArg, void * secondArg);
void intDestroy( void * thingToDestroy);

int charCompare( void * firstArg, void * secondArg);
void charDestroy( void * thingToDestroy);
...
// void printList(SortedListPtr listPtr);
